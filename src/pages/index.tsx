  ...
  return (
    <main className='m-0 p-0 bg-greenpri-200'>
      ...
      <section className='bg-greenpri-600 flex flex-col justify-center items-center p-10'>
        ...
        <iframe className='max-w-3xl' src="https://open.spotify.com/embed/episode/2WgiqSHWsih8un0ZUlmkLE?utm_source=generator&theme=0" width="100%" height="152" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
      </section>
