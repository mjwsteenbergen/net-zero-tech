  ...
  return (
    <main className='m-0 p-0 bg-greenpri-200'>
      ...
      <section className='bg-greenpri-600 flex flex-col justify-center items-center p-10'>
        ...
        <iframe className='max-w-3xl rounded-xl' src="https://open.spotify.com/embed/show/1QnbhsHHYsZAGG1cl7zUhS?utm_source=generator&theme=0" width="100%" height="152" frameBorder="0" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
      </section>
